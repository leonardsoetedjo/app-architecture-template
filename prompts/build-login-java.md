...
- **Stack:** React frontend + Java Spring Boot backend
- **Auth:** Spring Security with server-side sessions (simple, not JWT)
...
*Prompt version: 1.0*  
*Created: 2026-06-21*  
*Purpose: Validate that the app-architecture-template React + Java boilerplate can produce a working authentication flow.*
