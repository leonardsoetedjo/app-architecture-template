...
- **General Patterns**: Refer to [`docs/agnostic/guidelines/patterns.md`](docs/agnostic/guidelines/patterns.md) for a catalog of approved vs. discouraged coding patterns.
...
## 5. REST API Design
(Refer to [`docs/agnostic/standards/architecture.md`](docs/agnostic/standards/architecture.md) for general REST conventions. Implementation details are as follows:)
...
## 6. Batch Processing
Use Celery or Airflow for batch processing. See [`docs/platforms/python-quasar/guidelines/batch/implementation.md`](docs/platforms/python-quasar/guidelines/batch/implementation.md) (TBD).
...
- Store files in PostgreSQL using `BYTEA` (Refer to [`docs/agnostic/adr/008-file-storage-in-db.md`](docs/agnostic/adr/008-file-storage-in-db.md)).
