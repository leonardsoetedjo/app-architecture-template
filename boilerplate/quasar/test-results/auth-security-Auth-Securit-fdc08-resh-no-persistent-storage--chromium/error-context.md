...
- Name: auth-security.spec.ts >> Auth Security — No localStorage Tokens >> token is lost on page refresh (no persistent storage)
- Location: e2e/auth-security.spec.ts:59:3
