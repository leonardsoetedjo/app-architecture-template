...
def log_use_case(func):
    """
    A decorator that mimics the Spring AOP behavior.
    It logs the entry and exit of a use case with its duration.
    """
    ...
    async def wrapper(*args, **kwargs):
        ...
        # Ensure traceId exists in context
        current_trace = correlation_id.get()
        ...
        try:
            ...
            logger.info(f"Completed UseCase: {method_name} in {duration:.2f}ms")
            return result
